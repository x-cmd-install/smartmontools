...
```sh
x install smartmontools
```

## 代码洞察

合计: **80,485** 行代码（覆盖前 5 种语言、共 **129** 个文件）。
...
- **上游仓库**: <https://github.com/smartmontools/smartmontools>
- **官网**: <https://www.smartmontools.org/browser>
- **许可证**: GPL-2.0
...
- **Star**: 1,358 · **Fork**: 283 · **开放 issue**: 401 · **贡献者**: 83

## 累计统计

- **发布数**: 10 · **已合并 PR**: 95 · **开放 PR**: 10 · **已关闭 issue**: 336 · **开放 issue**: 65 · **提交数**: 6229

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-12 | 0 | 0 | 2 | 8 | 3 | 34 |
| last60d | 2026-07-13 | 0 | 2 | 2 | 13 | 4 | 112 |
| 90d | 2026-06-13 | 0 | 11 | 2 | 18 | 8 | 131 |
| last180d | 2026-03-15 | 0 | 20 | 4 | 40 | 16 | 174 |
| 360d | 2025-09-16 | 0 | 78 | 5 | 113 | 31 | 419 |
| last720d | 2024-09-21 | 1 | 95 | 5 | 167 | 42 | 672 |
...
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/smartmontools.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260911.yml` · 2026-09-11T20:47:41Z._
